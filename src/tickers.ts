...
export const TICKERS: TickerConfig[] = [
  ...
  { id: 'BZK26.NYM',   name: 'Brent 2M Future',      class: 'energy', family: 'brent', age: 28, tenor_months: 2 },
  { id: 'BZN26.NYM',   name: 'Brent 4M Future',      class: 'energy', family: 'brent', age: 35, tenor_months: 4 },
  ...
  { id: 'CLN26.NYM',   name: 'WTI 3M Future',        class: 'energy', family: 'wti', age: 32, tenor_months: 3 },
  ...
  { id: 'FRED:GASREGW', name: 'US Regular Gas Price', class: 'energy', family: 'consumer', age: 55 },
